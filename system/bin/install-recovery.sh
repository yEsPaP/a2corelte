#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/13540000.dwmmc0/by-name/RECOVERY:22235680:fb2e5953c0de90a3f59aec04cb21713119a04051; then
  applypatch EMMC:/dev/block/platform/13540000.dwmmc0/by-name/BOOT:17990176:e1326861a966a25555420bf5c1070c3e0274603b EMMC:/dev/block/platform/13540000.dwmmc0/by-name/RECOVERY fb2e5953c0de90a3f59aec04cb21713119a04051 22235680 e1326861a966a25555420bf5c1070c3e0274603b:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
